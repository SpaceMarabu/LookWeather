...
fun FavouriteContent(component: FavouriteComponent) {
    ...
    LazyVerticalGrid(
        ...
        item {
            AddFavouriteCityCard { component.onClickAddFavourite() }
        }
    }
}

//<editor-fold desc="SearchCard">
@Composable
...
//<editor-fold desc="AddFavouriteCityCard">
@Composable
...
//<editor-fold desc="getGradientByIndex">
